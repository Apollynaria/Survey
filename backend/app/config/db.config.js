var dbProperties = {
    database: 'oprosnik', // название базы данных
...
db.answer = require('../model/answer.model.js')(sequelize, Sequelize);
db.survey = require('../model/survey.model.js')(sequelize, Sequelize);
db.user_answer = require('../model/user_answer.model.js')(sequelize, Sequelize);
